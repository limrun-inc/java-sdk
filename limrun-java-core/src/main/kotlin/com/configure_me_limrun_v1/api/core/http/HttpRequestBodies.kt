...
import com.configure_me_limrun_v1.api.core.MultipartField
    ...
    object : HttpRequestBody {
        ...
        private fun serializePart(
            ...
            when (node.nodeType) {
                            ...
                            node
                                ...
                                .mapNotNull { element ->
                                    when (element.nodeType) {
                                        ...
                                        JsonNodeType.OBJECT,
                                        JsonNodeType.POJO ->
                                            throw LimrunInvalidDataException(
                ...
                JsonNodeType.POJO,
                null ->
                    throw LimrunInvalidDataException("Unexpected JsonNode type: ${node.nodeType}")
            }

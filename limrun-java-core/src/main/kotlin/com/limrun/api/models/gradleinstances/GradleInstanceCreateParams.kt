...
class GradleInstanceCreateParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): GradleInstanceCreateParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [GradleInstanceCreateParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [GradleInstanceCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(gradleInstanceCreateParams: GradleInstanceCreateParams) = apply {
            reuseIfExists = gradleInstanceCreateParams.reuseIfExists
            wait = gradleInstanceCreateParams.wait
            body = gradleInstanceCreateParams.body.toBuilder()
            additionalHeaders = gradleInstanceCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = gradleInstanceCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [GradleInstanceCreateParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): GradleInstanceCreateParams =
    ...
    private constructor(
        ...
        ) : this(clues, hardTimeout, inactivityTimeout, jurisdiction, region, mutableMapOf())
         ...
         * once the instance becomes ready. Example values 1m, 10m, 3h. Default is 5m; a
        ...
        class Builder internal constructor() {
             ...
             * starts once the instance becomes ready. Example values 1m, 10m, 3h. Default is 5m; a
             * non-positive value falls back to the default.
             */
        ...
        override fun toString() =
            "Spec{clues=$clues, hardTimeout=$hardTimeout, inactivityTimeout=$inactivityTimeout, jurisdiction=$jurisdiction, region=$region, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is GradleInstanceCreateParams &&
    ...
    override fun toString() =
        "GradleInstanceCreateParams{reuseIfExists=$reuseIfExists, wait=$wait, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}

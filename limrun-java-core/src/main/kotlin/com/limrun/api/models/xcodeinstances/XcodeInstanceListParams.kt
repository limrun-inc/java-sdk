...
private constructor(
    ...
    /**
     * State filter to apply to Xcode instances to return. Each comma-separated state will be used
    ...
    companion object {
        ...
        @JvmStatic fun none(): XcodeInstanceListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [XcodeInstanceListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [XcodeInstanceListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(xcodeInstanceListParams: XcodeInstanceListParams) = apply {
            endingBefore = xcodeInstanceListParams.endingBefore
            labelSelector = xcodeInstanceListParams.labelSelector
            limit = xcodeInstanceListParams.limit
            startingAfter = xcodeInstanceListParams.startingAfter
            state = xcodeInstanceListParams.state
            additionalHeaders = xcodeInstanceListParams.additionalHeaders.toBuilder()
            additionalQueryParams = xcodeInstanceListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * State filter to apply to Xcode instances to return. Each comma-separated state will be
        ...
        /**
         * Returns an immutable instance of [XcodeInstanceListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): XcodeInstanceListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is XcodeInstanceListParams &&
    ...
    override fun toString() =
        "XcodeInstanceListParams{endingBefore=$endingBefore, labelSelector=$labelSelector, limit=$limit, startingAfter=$startingAfter, state=$state, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}

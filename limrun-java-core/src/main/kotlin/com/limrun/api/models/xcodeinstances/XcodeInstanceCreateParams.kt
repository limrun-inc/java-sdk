...
class XcodeInstanceCreateParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): XcodeInstanceCreateParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [XcodeInstanceCreateParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [XcodeInstanceCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(xcodeInstanceCreateParams: XcodeInstanceCreateParams) = apply {
            reuseIfExists = xcodeInstanceCreateParams.reuseIfExists
            wait = xcodeInstanceCreateParams.wait
            body = xcodeInstanceCreateParams.body.toBuilder()
            additionalHeaders = xcodeInstanceCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = xcodeInstanceCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [XcodeInstanceCreateParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): XcodeInstanceCreateParams =
    ...
    private constructor(
        ...
        ) : this(clues, hardTimeout, inactivityTimeout, region, mutableMapOf())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(clues, hardTimeout, inactivityTimeout, region, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Spec{clues=$clues, hardTimeout=$hardTimeout, inactivityTimeout=$inactivityTimeout, region=$region, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is XcodeInstanceCreateParams &&
    ...
    override fun toString() =
        "XcodeInstanceCreateParams{reuseIfExists=$reuseIfExists, wait=$wait, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}

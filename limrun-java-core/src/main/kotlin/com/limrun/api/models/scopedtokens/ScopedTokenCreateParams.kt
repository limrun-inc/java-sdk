...
private constructor(
    private val scopedTokenCreate: ScopedTokenCreate,
    private val additionalHeaders: Headers,
    private val additionalQueryParams: QueryParams,
) : Params {

    fun scopedTokenCreate(): ScopedTokenCreate = scopedTokenCreate

    fun _additionalBodyProperties(): Map<String, JsonValue> =
        scopedTokenCreate._additionalProperties()
    ...
    class Builder internal constructor() {
        ...
        private var scopedTokenCreate: ScopedTokenCreate? = null
        private var additionalHeaders: Headers.Builder = Headers.builder()
        private var additionalQueryParams: QueryParams.Builder = QueryParams.builder()

        @JvmSynthetic
        internal fun from(scopedTokenCreateParams: ScopedTokenCreateParams) = apply {
            scopedTokenCreate = scopedTokenCreateParams.scopedTokenCreate
        ...
        fun scopedTokenCreate(scopedTokenCreate: ScopedTokenCreate) = apply {
            this.scopedTokenCreate = scopedTokenCreate
        }
        ...
        fun build(): ScopedTokenCreateParams =
            ScopedTokenCreateParams(
                checkRequired("scopedTokenCreate", scopedTokenCreate),
                additionalHeaders.build(),
                additionalQueryParams.build(),
            )
    }

    fun _body(): ScopedTokenCreate = scopedTokenCreate
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ScopedTokenCreateParams &&
            scopedTokenCreate == other.scopedTokenCreate &&
            additionalHeaders == other.additionalHeaders &&
            additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int =
        Objects.hash(scopedTokenCreate, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "ScopedTokenCreateParams{scopedTokenCreate=$scopedTokenCreate, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}

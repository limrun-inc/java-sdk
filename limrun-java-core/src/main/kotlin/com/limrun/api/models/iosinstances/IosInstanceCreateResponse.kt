...
class IosInstanceCreateResponse
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [IosInstanceCreateResponse].
         *
    ...
    /** A builder for [IosInstanceCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(iosInstanceCreateResponse: IosInstanceCreateResponse) = apply {
            metadata = iosInstanceCreateResponse.metadata
            spec = iosInstanceCreateResponse.spec
            status = iosInstanceCreateResponse.status
            additionalProperties = iosInstanceCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [IosInstanceCreateResponse].
         *
         ...
         */
        fun build(): IosInstanceCreateResponse =
    ...
    fun validate(): IosInstanceCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IosInstanceCreateResponse &&
    ...
    override fun toString() =
        "IosInstanceCreateResponse{metadata=$metadata, spec=$spec, status=$status, additionalProperties=$additionalProperties}"
}

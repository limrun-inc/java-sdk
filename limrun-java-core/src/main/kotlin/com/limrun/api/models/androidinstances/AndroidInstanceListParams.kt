...
private constructor(
    ...
    /**
     * Return records up until this instance ID. If not given, it will return up until the 50th
     * instance.
     */
    ...
    /**
     * Return records starting after this instance ID. If not given, it will start from the most
     * recent one.
     */
    ...
    companion object {
        ...
        @JvmStatic fun none(): AndroidInstanceListParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [AndroidInstanceListParams].
         */
    ...
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [AndroidInstanceListParams].
         *

...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [GradleInstance].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(gradleInstance: GradleInstance) = apply {
            metadata = gradleInstance.metadata
            spec = gradleInstance.spec
            status = gradleInstance.status
            additionalProperties = gradleInstance.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [GradleInstance].
         *
     ...
     *   expected type.
     */
    fun validate(): GradleInstance = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is GradleInstance &&
    ...
    override fun toString() =
        "GradleInstance{metadata=$metadata, spec=$spec, status=$status, additionalProperties=$additionalProperties}"
}

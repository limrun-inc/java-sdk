...
class GradleInstanceListParams
private constructor(
    ...
    /**
     * State filter to apply to Gradle instances to return. Each comma-separated state will be used
    ...
    companion object {
        ...
        @JvmStatic fun none(): GradleInstanceListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [GradleInstanceListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [GradleInstanceListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(gradleInstanceListParams: GradleInstanceListParams) = apply {
            endingBefore = gradleInstanceListParams.endingBefore
            labelSelector = gradleInstanceListParams.labelSelector
            limit = gradleInstanceListParams.limit
            startingAfter = gradleInstanceListParams.startingAfter
            state = gradleInstanceListParams.state
            additionalHeaders = gradleInstanceListParams.additionalHeaders.toBuilder()
            additionalQueryParams = gradleInstanceListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * State filter to apply to Gradle instances to return. Each comma-separated state will be
        ...
        /**
         * Returns an immutable instance of [GradleInstanceListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): GradleInstanceListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is GradleInstanceListParams &&
    ...
    override fun toString() =
        "GradleInstanceListParams{endingBefore=$endingBefore, labelSelector=$labelSelector, limit=$limit, startingAfter=$startingAfter, state=$state, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}

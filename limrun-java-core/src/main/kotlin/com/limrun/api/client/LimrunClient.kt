...
/**
 * A client for interacting with the Limrun REST API synchronously. You can also switch to
...
interface LimrunClient {
     ...
     */
    fun withOptions(modifier: Consumer<ClientOptions.Builder>): LimrunClient

    fun androidInstances(): AndroidInstanceService

    fun assets(): AssetService

    fun iosInstances(): IosInstanceService

    fun xcodeInstances(): XcodeInstanceService

    fun gradleInstances(): GradleInstanceService
    ...
    /** A view of [LimrunClient] that provides access to raw HTTP responses for each method. */
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): LimrunClient.WithRawResponse

        fun androidInstances(): AndroidInstanceService.WithRawResponse
        ...
        fun gradleInstances(): GradleInstanceService.WithRawResponse

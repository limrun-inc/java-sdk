...
import com.configure_me_limrun_v1.api.client.okhttp.OkHttpClient
import com.configure_me_limrun_v1.api.core.RequestOptions
import com.configure_me_limrun_v1.api.errors.LimrunRetryableException
        ...
        val failingHttpClient =
            object : HttpClient {
                override fun execute(
                    ...
                    callCount++
                    if (callCount == 1) {
                        throw LimrunRetryableException("Simulated retryable failure")
                    }
                ...
                override fun executeAsync(
                    ...
                    if (callCount == 1) {
                        ...
                        future.completeExceptionally(
                            LimrunRetryableException("Simulated retryable failure")
                        )
                        return future
                    }

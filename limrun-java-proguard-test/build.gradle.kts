...
dependencies {
    testImplementation(project(":limrun-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../limrun-java-core/src/main/resources/META-INF/proguard/limrun-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.configure_me_limrun_v1.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../limrun-java-core/src/main/resources/META-INF/proguard/limrun-java-core.pro",

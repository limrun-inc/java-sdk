...
import com.configure_me_limrun_v1.api.core.http.HttpRequestBody
import com.configure_me_limrun_v1.api.core.http.HttpResponse
import com.configure_me_limrun_v1.api.errors.LimrunIoException
...
class OkHttpClient private constructor(private val okHttpClient: okhttp3.OkHttpClient) :
    ...
    override fun execute(request: HttpRequest, requestOptions: RequestOptions): HttpResponse {
        ...
        return try {
            ...
            throw LimrunIoException("Request failed", e)
        } finally {
            request.body?.close()
        }
    }
            ...
            .enqueue(
                object : Callback {
                    ...
                    override fun onFailure(call: Call, e: IOException) {
                        future.completeExceptionally(LimrunIoException("Request failed", e))
                    }
                }
            )
    ...
    private fun newCall(request: HttpRequest, requestOptions: RequestOptions): Call {
        ...
        val logLevel =
            when (System.getenv("LIMRUN_LOG")?.lowercase()) {

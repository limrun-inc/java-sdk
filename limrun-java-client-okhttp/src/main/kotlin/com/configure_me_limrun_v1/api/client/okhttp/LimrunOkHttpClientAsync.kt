...
package com.configure_me_limrun_v1.api.client.okhttp

import com.configure_me_limrun_v1.api.client.LimrunClientAsync
import com.configure_me_limrun_v1.api.client.LimrunClientAsyncImpl
import com.configure_me_limrun_v1.api.core.ClientOptions
import com.configure_me_limrun_v1.api.core.Timeout
import com.configure_me_limrun_v1.api.core.http.Headers
import com.configure_me_limrun_v1.api.core.http.HttpClient
...
/**
 * A class that allows building an instance of [LimrunClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class LimrunOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [LimrunClientAsync]. */
         ...
         */
        @JvmStatic fun fromEnv(): LimrunClientAsync = builder().fromEnv().build()
    }

    /** A builder for [LimrunOkHttpClientAsync]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [com.configure_me_limrun_v1.api.core.jsonMapper]. The default is usually
         ...
         *
         * Defaults to the production environment: `https://api.limrun.com`.
         */
        ...
        /**
         * Returns an immutable instance of [LimrunClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LimrunClientAsync =
            LimrunClientAsyncImpl(
                clientOptions
                    .httpClient(

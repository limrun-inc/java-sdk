...
import com.configure_me_limrun_v1.api.client.LimrunClientImpl
...
/**
 * A class that allows building an instance of [LimrunClient] with [OkHttpClient] as the underlying
 * [HttpClient].
 */
class LimrunOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [LimrunClient]. */
         ...
         */
        @JvmStatic fun fromEnv(): LimrunClient = builder().fromEnv().build()
    }

    /** A builder for [LimrunOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [LimrunClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LimrunClient =
            LimrunClientImpl(
                clientOptions
                    .httpClient(
